...
const Hero: React.FC = () => {
  ...
  return (
    <section
      id="home"
      className="relative flex min-h-screen items-center overflow-x-hidden pt-24 pb-14 sm:pt-28 lg:pt-32 lg:overflow-visible"
    >
      <div className="relative z-10 mx-auto grid w-full max-w-6xl grid-cols-1 items-center gap-8 px-5 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:gap-12">
        ...
        <motion.div
          ...
          className="relative mx-auto flex h-[300px] w-[300px] items-center justify-center sm:h-[360px] sm:w-[360px] lg:h-[420px] lg:w-[420px]"
        >
         <div className="relative h-[260px] w-[260px] overflow-visible rounded-[40px] bg-[#081f37] sm:h-[320px] sm:w-[320px] lg:h-[360px] lg:w-[360px]">
  <div className="absolute inset-0 flex items-center justify-center">
    <div className="h-40 w-40 rounded-full bg-cyan-500/15 blur-[90px] sm:h-52 sm:w-52 lg:h-60 lg:w-60"></div>
  </div>
  ...
  />
          ...
          {/* Floating tech chips */}
          <motion.div
  className="absolute bottom-4 left-2 z-30 flex h-9 w-9 items-center justify-center rounded-xl glass shadow-glass sm:bottom-6 sm:left-6 sm:h-10 sm:w-10 lg:bottom-8 lg:left-8 lg:h-12 lg:w-12"
  animate={{ y: [0, -8, 0] }}
...
>
  <FaJava size={20} />
         ...
         <motion.div
  className="absolute left-2 top-6 z-30 flex h-9 w-9 -translate-x-1/2 items-center justify-center rounded-xl glass shadow-glass sm:left-0 sm:top-8 sm:h-10 sm:w-10 lg:top-10 lg:h-12 lg:w-12"
  animate={{ y: [0, -10, 0] }}
...
>
  <SiPython size={20} />
         ...
         <motion.div
  className="absolute right-2 top-1/2 z-30 flex h-9 w-9 translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-xl glass shadow-glass sm:right-0 sm:h-10 sm:w-10 lg:h-12 lg:w-12"
  animate={{ y: [0, 10, 0] }}
